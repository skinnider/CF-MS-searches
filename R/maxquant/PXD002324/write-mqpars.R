# Write mqpar files for the PXD002324 (Wan et al., anemone) dataset.
...
for (input_file in input_files) {
  ...
  # remove fractions that were not uploaded to PRIDE
  if (expt_name == "Nv_HCW_1") 
    fractions %<>% extract(!grepl("P2BA", .))
