# Write mqpar files for the PXD013093 (McWhite et al., Cell 2020) 
# Selalginella moellendorffii dataset.
...
replicates = ifelse(grepl("SEC", files), "selml_frond1", "selml_frond2")
