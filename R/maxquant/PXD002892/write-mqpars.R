...
# replicates[grepl("20130826", files)] = "BN1"
# replicates[grepl("BNPAGE_apoptosis_mito_rep2", files)] = "BN2"
# replicates[grepl("4hr_Mito_rep3", files)] = "BN3"
# replicates[grepl("130715_PCP_SILAC_apoptosis", files)] = "SEC1"
# replicates[grepl("20130906_SEC", files)] = "SEC2"
# replicates[grepl("SEC_apoptosis_bio_rep3", files)] = "SEC3"

#' summary:
#' 1. untreated BN-PAGE, mitochondria (50 fractions, Table EV1):
#'   BN_PCP_SILAC_mito
#'   
#' 2. apoptosis, BN-PAGE, mitochondria (55 fractions, Table EV11):
#' present in MaxQuant experimentalDesignTemplate.txt on PRIDE
#'   i. 20130826: replicate 1
#'   ii. BNPAGE_apoptosis_mito_rep2: replicate 2
#'   iii. 4hr_Mito_rep3: replicate 3
#'   
#' 3. apoptosis, SEC, cytoplasm:
#'    i. 130715_PCP_SILAC_apoptosis: replicate 1
#'    ii. 20130906_SEC: replicate 2
#'    iii. SEC_apoptosis_bio_rep3: replicate 3

# reconstruct experimental design
replicate_patts = c(
  'untreated' = '20130426|20130501',
  'BN1' = '20130826',
