# Write mqpar files for the PXD014617 (McWhite et al., Cell 2020) 
# Arabidopsis thaliana (3/3) dataset.
...
patts = c('arath_dark1' = 'AT_indark_IEX',
          'arath_dark2' = 'AT_indark_IEX(.*?)a_',
          'arath_leaf1' = 'WAN141117',
          'arath_leaf2' = 'AT_leaf_IEX')
